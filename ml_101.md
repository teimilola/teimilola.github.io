...
By specifying {% ihighlight python %}min_df=10{% endihighlight %} we've required that each word occur in at least 10 documents. This eliminates rare words from our features. By specifying norm=l2, we scall the feature values to take into account the document lenght.
